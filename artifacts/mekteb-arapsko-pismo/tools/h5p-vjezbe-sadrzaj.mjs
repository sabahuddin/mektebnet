...
export const VJEZBE = [
  ...
  // ─────────────────────────────────────────────────────────────
  // Ranije Flashcards. Zamijenjeno: Flashcards traži da dijete UPIŠE pojam,
  // a poređenje je doslovno — „sedzda“ umjesto „sedžda“ se odbija. Prepoznavanje
  // ponuđenog pojma provjerava znanje, a ne tipkanje.
  {
    slug: "sartovi-pojmovi",
    tip: "scs",
    naslov: "Prepoznaj pojam — šartovi",
    uvod: "Pročitaj opis i odaberi pojam. Deset kratkih pitanja.",
    pitanja: [
      { pitanje: "Odluka srcem koji namaz klanjamo, prije nego namaz počne.",
        odgovori: ["Nijet", "Tekbir", "Kijam", "Kiraet"] },
      { pitanje: "Smjer prema kojem se okrećemo kada klanjamo.",
        odgovori: ["Kibla", "Sedžda", "Ruku'", "Nijet"] },
      { pitanje: "Zamjena za abdest kada nema vode.",
        odgovori: ["Tejemmum", "Gusul", "Mesh", "Abdest"] },
      { pitanje: "Stupanj svijesti da nas Allah vidi i kad nas ljudi ne vide.",
        odgovori: ["Ihsan", "Iman", "Islam", "Nijet"] },
      { pitanje: "Spuštanje lica na tlo u namazu.",
        odgovori: ["Sedžda", "Ruku'", "Kijam", "Ka'de"] },
      { pitanje: "Pregibanje u namazu, poslije učenja Kur'ana.",
        odgovori: ["Ruku'", "Sedžda", "Kijam", "Tekbir"] },
      { pitanje: "Stajanje u namazu.",
        odgovori: ["Kijam", "Ruku'", "Sedžda", "Kiraet"] },
      { pitanje: "Učenje Kur'ana u namazu.",
        odgovori: ["Kiraet", "Kijam", "Zikr", "Dova"] },
      { pitanje: "Propisano izdvajanje dijela imetka za one kojima treba.",
        odgovori: ["Zekat", "Sadaka", "Hadž", "Post"] },
      { pitanje: "Pranje lica, ruku, potiranje glave i pranje nogu prije namaza.",
        odgovori: ["Abdest", "Gusul", "Tejemmum", "Mesh"] },
    ],
  },
];
