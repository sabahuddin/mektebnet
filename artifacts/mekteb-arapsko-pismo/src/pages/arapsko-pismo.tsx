...
const HARFOVI: Harf[] = [
  ...
  { id: 17, arabic: "ظ", name: "Zâ",   trans: "Z (jako)",   dots: 1, connecting: true,  group: "Grupa 6",  audioFile: "za.mp3" },
  ...
  { id: 27, arabic: "و", name: "Vav",  trans: "W / U",      dots: 0, connecting: false, group: "Grupa 10", audioFile: "waw.mp3" },
