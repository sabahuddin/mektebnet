...
export const LESSONS: LessonData[] = [
  ...
  // ── LEKCIJA 3 ───────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        icon: "🔗", hasanatReward: 20,
        choices: ["be-te", "te-be", "se-be", "bi-te", "tu-be", "be-se", "se-te", "ti-be", "bu-se", "e-be", "e-te", "te-se", "si-be"],
        items: [
      ...
      },
      {
        ...
        items: [
          { show: "أَبَتَ", answer: "e-be-te"  },
          { show: "أَتَبَ", answer: "e-te-be"  },
          { show: "أَثَبَ", answer: "e-se-be"  },
          { show: "بَأَتَ", answer: "be-e-te"  },
          { show: "بَتَأَ", answer: "be-te-e"  },
          { show: "بَتَثَ", answer: "be-te-se" },
          { show: "بَثَتَ", answer: "be-se-te" },
          { show: "تَأَبَ", answer: "te-e-be"  },
          { show: "تَبَأَ", answer: "te-be-e"  },
          { show: "تَبَثَ", answer: "te-be-se" },
          { show: "تَثَبَ", answer: "te-se-be" },
          { show: "ثَأَبَ", answer: "se-e-be"  },
          { show: "ثَبَأَ", answer: "se-be-e"  },
          { show: "ثَبَتَ", answer: "se-be-te" },
          { show: "ثَتَبَ", answer: "se-te-be" },
          { show: "أَبُتُ", answer: "e-bu-tu"  },
          { show: "أَتُبُ", answer: "e-tu-bu"  },
          { show: "أَثُبُ", answer: "e-su-bu"  },
          { show: "بُأَتُ", answer: "bu-e-tu"  },
          { show: "بُتَأُ", answer: "bu-te-u"  },
          { show: "بُتُثُ", answer: "bu-tu-su" },
          { show: "بُثَتُ", answer: "bu-se-tu" },
          { show: "تُأَبُ", answer: "tu-e-bu"  },
          { show: "تُبَأُ", answer: "tu-be-u"  },
          { show: "تُبُثُ", answer: "tu-bu-su" },
          { show: "تُثَبُ", answer: "tu-se-bu" },
          { show: "ثُأَبُ", answer: "su-e-bu"  },
  ...
  // ── LEKCIJA 5 ───────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        icon: "🔗🔗", hasanatReward: 30,
        choices: ["be-ha-se", "ha-dže-be", "hâ-be-se", "dže-be-te", "te-dže-ha", "bu-džu-ha", "hâ-dže-be", "dži-be-se", "se-be-te", "te-be-se", "ha-be-se", "dže-ha-be", "bi-te-se", "e-be-te", "hâ-u-be-dže"],
        items: [
          { show: "بَحَثَ", answer: "be-ha-se"   },
          { show: "حَجَبَ", answer: "ha-dže-be"  },
          { show: "خَبَثَ", answer: "hâ-be-se"   },
  ...
  // ── LEKCIJA 17: PONAVLJANJE SVIH HARFOVA ──────────────────
  {
    ...
    exercises: [
      ...
      {
        type: "čitaj-slog", title: "Čitaj riječi sa sukunom, tešdidom i tenvinom", description: "Svaka riječ nosi bar jedan znak koji si naučio. Pročitaj je povezano, pa provjeri uz snimak.",
        icon: "📖", hasanatReward: 60, choices: [],
        items: [
          { show: "عَبْدٌ", answer: "Sukun na Ba, tenvin damma" }, { show: "عِلْمٌ", answer: "Sukun na Lam, tenvin damma" },
          { show: "حُكْمٌ", answer: "Sukun na Kef, tenvin damma" }, { show: "صَبْرٌ", answer: "Sukun na Ba, tenvin damma" },
          { show: "فَجْرٌ", answer: "Sukun na Džim, tenvin damma" }, { show: "وَجْهٌ", answer: "Sukun na Džim, tenvin damma" },
          { show: "سِحْرٌ", answer: "Sukun na Ha, tenvin damma" }, { show: "نَهْرٌ", answer: "Sukun na He, tenvin damma" },
          { show: "مَسْجِدٌ", answer: "Sukun na Sin, tenvin damma" }, { show: "مُسْلِمٌ", answer: "Sukun na Sin, tenvin damma" },
          { show: "يَعْلَمُ", answer: "Sukun na Ajn" }, { show: "يَعْمَلُ", answer: "Sukun na Ajn" },
          { show: "مَعَكُمْ", answer: "Sukun na Mim" }, { show: "نَعَمْ", answer: "Sukun na Mim" },
          { show: "رَبَّ", answer: "Tešdid na Ba" }, { show: "شَرٌّ", answer: "Tešdid i tenvin na Ra" },
          { show: "حَقٌّ", answer: "Tešdid i tenvin na Kaf" }, { show: "وَلِيٌّ", answer: "Tešdid i tenvin na Ja" },
          { show: "بَشِّرْ", answer: "Tešdid na Šin, sukun na Ra" }, { show: "أَجْرًا", answer: "Sukun na Džim, tenvin fetha" },
        ],
      },
    ],
  },
...
for (const lesson of LESSONS) {
  ...
  lesson.exercises.push({
    type: "čitaj-slog",
    title: lesson.id < 6 ? "Čitaj 15 slogova i spojeva" : "Čitaj 15 riječi i spojeva",
    description: "Prikazano je 15 nasumičnih zapisa iz fonda od 30. Čitaj prvo samostalno, zatim provjeri gotov audio-snimak.",
    icon: "📖", hasanatReward: 60, choices: [],
